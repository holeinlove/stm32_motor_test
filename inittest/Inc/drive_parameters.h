...
#define MAX_APPLICATION_SPEED_RPM           12000 /*!< rpm, mechanical */
#define MIN_APPLICATION_SPEED_RPM           0 /*!< rpm, mechanical, absolute value */
#define M1_SS_MEAS_ERRORS_BEFORE_FAULTS     255 /*!< Number of speed measurement errors before main sensor goes in fault */

/****** State Observer + PLL ****/
#define VARIANCE_THRESHOLD                  1 /*!< Maximum accepted variance on speed estimates (percentage) */
...
#define PLL_KP_GAIN                         3192
#define PLL_KI_GAIN                         141
...
#define SW_DEADTIME_NS                      75 /*!< Dead-time to be inserted by FW, only if low side signals are enabled */
...
#define PID_TORQUE_KI_DEFAULT               480
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2304
#define PID_FLUX_KI_DEFAULT                 480
...
#define PID_SPEED_KP_DEFAULT                3287/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                23/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            4320
...
#define UD_VOLTAGE_THRESHOLD_V              4 /*!< Under-voltage threshold */
#ifdef NOT_IMPLEMENTED
#define ON_OVER_VOLTAGE                     TURN_OFF_PWM /*!< TURN_OFF_PWM, TURN_ON_R_BRAKE or TURN_ON_LOW_SIDES */
#endif /* NOT_IMPLEMENTED */
#define OV_TEMPERATURE_THRESHOLD_C          120 /*!< Celsius degrees */
...
#define PHASE2_FINAL_CURRENT_A              4

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (4800*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              13.4

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (4800*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              13.4

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (4800*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A              13.4
