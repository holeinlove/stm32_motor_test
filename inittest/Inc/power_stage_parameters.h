...
#define VBUS_PARTITIONING_FACTOR             0.03194888178913738 /*!< It expresses how
...
#define AMPLIFICATION_GAIN                   0.044

/*** Noise parameters ***/
#define TNOISE_NS                            200
#define TRISE_NS                             200
#define MAX_TNTR_NS                          TRISE_NS

/************ Temperature sensing section ***************/
/* V[V]=V0+dV/dT[V/Celsius]*(T-T0)[Celsius]*/
#define V0_V                                 1.1 /*!< in Volts */
#define T0_C                                 25 /*!< in Celsius degrees */
#define dV_dT                                0.033 /*!< V/Celsius degrees */
#define T_MAX                                120 /*!< Sensor measured
