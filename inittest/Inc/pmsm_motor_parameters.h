...
#define RS                      0.05 /* Stator resistance , ohm*/
...
#define MOTOR_VOLTAGE_CONSTANT  1.7 /*!< Volts RMS ph-ph /kRPM */
#define MOTOR_MAX_SPEED_RPM     12000 /*!< Maximum rated speed  */
#define NOMINAL_CURRENT_A       13.4

#define ID_DEMAG_A              -13.4 /*!< Demagnetization current */
