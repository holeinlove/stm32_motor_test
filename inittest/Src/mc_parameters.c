...
/* Current reading A/D Conversions initialization -----------------------------*/
  .ADCx_1 = ADC1,
  .ADCx_2 = ADC2,
  .ADCConfig1        = (uint32_t)(MC_ADC_CHANNEL_2 << ADC_JSQR_JSQ1_Pos) | LL_ADC_INJ_TRIG_EXT_RISING
                     | LL_ADC_INJ_TRIG_EXT_TIM1_TRGO,
  .ADCConfig2        = (uint32_t)(MC_ADC_CHANNEL_13 << ADC_JSQR_JSQ1_Pos) | LL_ADC_INJ_TRIG_EXT_RISING
                     | LL_ADC_INJ_TRIG_EXT_TIM1_TRGO,
